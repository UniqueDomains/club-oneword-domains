...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C352%20rows-8250df">
...
> **Important:** this repository is a **public 7,352-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **7,357 domains** on the canonical page below.

**Public extract:** 7,352 rows · **Live catalog:** 7,357 domains
...
- `club.csv` — public CSV extract (7,352 rows)
- `club.json` — public JSON extract (7,352 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,352-row public sample | 7,357 live domains                               |
...
> Unique Domains. *Available .CLUB One-Word Domains*. Version 2026-04-13. Public GitHub extract for the exact Unique Domains search represented by this repository.
